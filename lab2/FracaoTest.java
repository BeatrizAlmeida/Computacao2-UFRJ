...
public class FracaoTest {
    ...
    public void testarFracaoGeratrizParaFracaoRedutivel() {
        ...
        assertTrue(fracaoGeratrizEsperada.getNumerador() == fracaoGeratrizObtida.getNumerador() &&  fracaoGeratrizEsperada.getDenominador() == fracaoGeratrizObtida.getDenominador() && fracaoGeratrizEsperada.getSinal() == fracaoGeratrizObtida.getSinal());
    }
